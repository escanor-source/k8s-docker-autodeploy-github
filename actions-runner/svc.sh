...
SVC_NAME="actions.runner.escanor-source-k8s-docker-autodeploy-github.ccsserver.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (escanor-source-k8s-docker-autodeploy-github.ccsserver)"
